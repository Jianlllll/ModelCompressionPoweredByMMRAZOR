...
class TeacherModel_HRNet_W48(nn.Module):
    def __init__(self, num_classes=1):
        super(TeacherModel_HRNet_W48, self).__init__()
        ...
        # 对齐权重的结构：stage4 使用 3 个 module（索引 0,1,2）
        ...
        # 最后一层 - 水印解码头
        last_inp_channels = sum(num_filters)  # 48+96+192+384 = 720
